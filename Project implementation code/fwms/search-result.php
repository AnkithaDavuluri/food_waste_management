   ...
   <div class="container">
      ...
      <section id="tables">
          ...
          <form method="post" action="search-result.php">
            <div class="col-6">
            <input type="text" name="pincode" placeholder="Search Food by Pincode" class="form-control">
          </div>
            <input type="submit" name="submit" class="">
          </form>
        </div>
               <h1>Search Result Against "<?php echo $_POST['pincode'];?>"</h1>
...
$ret=mysqli_query($con,"select * from  tblfood left join tblfoodrequests  on tblfood.ID=tblfoodrequests.foodId where tblfood.pincode='$pcode'");
$cnt=1;
