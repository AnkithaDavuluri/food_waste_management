...
<div class="w3layouts-main">
    ...
    echo $msg;
		...
		<form name="signup" method="post" onsubmit="return checkpass();">
			...
			<input type="password" class="ggg" name="password" id="password" placeholder="PASSWORD" required="true">
			<input type="password" class="ggg" name="repeatpassword" id="repeatpassword" placeholder="REPEAT PASSWORD" required="true">
