...
$fitemarray=implode(",",$fitem);
    $query=mysqli_query($con, "insert into tblfood(DonorID,foodId,StateName, CityName, FoodItems, Description, PickupDate,PickupAddress,ContactPerson,CPMobNumber,Image,pincode) value('$donorid','$fid','$statename','$cityname','$fitemarray','$description','$pdate','$padd','$contactperson','$cpmobnum','$foodpic','$pincode')");
...
<td><button type="button" name="add" id="add" class="btn btn-success">Add More</button></td>
         ...
         <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" id="pincode" name="pincode" type="text" required="true" maxlength="6" minlength="6">
                        </div>
                    </div>
