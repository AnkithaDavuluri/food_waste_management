...
$pincode=$_POST['pincode'];
    $query=mysqli_query($con, "update tblfood set FoodItems='$fitemarray',StateName='$statename', CityName='$cityname', Description='$description', PickupDate='$pdate', PickupAddress='$padd',ContactPerson='$contactperson',CPMobNumber='$cpmobnum',pincode='$pincode' where ID='$eid'");
    if ($query) {
...
<td><button type="button" name="add" id="add" class="btn btn-success">Add More</button></td>
       ...
       <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" id="pincode" name="pincode" type="text" required="true" maxlength="6" minlength="6" value="<?php echo $row['pincode'];?>">
                        </div>
                    </div>
